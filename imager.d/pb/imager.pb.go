...
type Image struct {
	...
	Thumb   string `protobuf:"bytes,3,opt,name=thumb" json:"thumb,omitempty"`
}
...
func (*NewImageRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (m *NewImageRequest) GetPhoto() []byte {
	if m != nil {
		return m.Photo
	}
	return nil
...
func (*NewImageResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *NewImageResponse) GetDocID() string {
	if m != nil {
		return m.DocID
	}
	return ""
...
func (m *NewImageResponse) GetPhotoID() string {
	if m != nil {
		return m.PhotoID
	}
	return ""
...
func (m *NewImageResponse) GetThumb() string {
	if m != nil {
		return m.Thumb
	}
	return ""
...
func (*ImagesFilter) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*ServiceDiscovery) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (x *imagerGetImagesClient) Recv() (*Image, error) {
	m := new(Image)
...
func (x *imagerGetImagesServer) Send(m *Image) error {
...
var _Imager_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "pb/imager.proto",
}

func init() { proto.RegisterFile("pb/imager.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 330 bytes of a gzipped FileDescriptorProto
	,
}
